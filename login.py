...
os.system('dialog --infobox "\tWelcome to my project of server management\n Hope you will find it interesting" 10 50')
time.sleep(2)
...
if choice == '1':
	...
	s.sendto("admin name is "+u,("192.168.0.6",1234))
        lout2.close   
	os.system("dialog --passwordbox 'Enter the password of the project' 10 30 2>  /root/Desktop/project1/password.txt")
